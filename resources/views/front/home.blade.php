            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12">
                    ...
                    @foreach ($products->take(1) as $product)
                        <div class="single-banner right"
                            style="background-image:url({{ $product->image_url }});margin-top: 30px;">
                            <div class="content">
                                <h2>{{ $product->name }} </h2>
                                <p>{{ $product->description }}</p>
                                <div class="price">
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="offer-content">
                        <div class="image">
                            <img src="{{ $halfDiscountProduct->image_url }}" alt="#">
                            <span class="sale-tag">-{{ $halfDiscountProduct->sale_percent }}%</span>
                        </div>
                        <div class="text">
                            <h2><a href="product-grids.html">{{ $halfDiscountProduct->name }}</a></h2>
                            <ul class="review">
                            ...
                            <div class="price">
                                <span>{{ App\Helpers\Currency::format($halfDiscountProduct->price) }}</span>
                                <span class="discount-price">{{ App\Helpers\Currency::format($halfDiscountProduct->compare_price) }}</span>
                            </div>
                            <p>{{ $halfDiscountProduct->description }}</p>
                        </div>
                        <div class="box-head">
                            <div class="box">
                                <h1 id="days">000</h1>
